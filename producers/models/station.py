...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"org.chicago.cta.station.arrivals.{self.station_name}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #logger.info("arrival kafka integration complete - producing")
        arrival = {
        ...
        if prev_station_id is not None:
            arrival["prev_station_id"] = prev_station_id
        if prev_direction is not None:
            arrival["prev_direction"] = prev_direction
        #print(arrival)
